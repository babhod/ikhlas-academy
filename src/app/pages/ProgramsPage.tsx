...
const programImages = {
  quran:
    "https://res.cloudinary.com/dhueginul/image/upload/v1773693606/1-rashidy_g2ihxh.png",
  arabic: "https://res.cloudinary.com/dhueginul/image/upload/v1773696748/1773696671921-019cf88e-ca95-7b54-9d64-a942541fb4aa_aylrc0.png",
...
export function ProgramsPage() {
  ...
  const programs: Program[] = [
    {
      title: "أتقن القراءة والتلاوة مع برنامج الجزء الرشيدي",
      description:
        "هل تطمح لقراءة \"جزء عمّ\" بطلاقة وفهم صحيح؟\\nيقدم لك هذا البرنامج رحلة تعليمية متكاملة تبدأ من أساسيات الحروف العربية وتصل بك إلى التلاوة المتقنة، بأسلوب مبسط ومناسب لجميع المستويات.",
      icon: <BookOpen size={40} />,
      outcomes: [
        "نطق الحروف العربية من مخارجها الصحيحة.",
        "إتقان قواعد التهجي والقراءة السليمة.",
        "تلاوة \"جزء عمّ\" بثقة وطلاقة.",
        "فهم المعاني الأساسية للآيات الكريمة.",
        "شهادة إتمام البرنامج عند الاجتياز.",
      ],
      level: "المستهدفون: مبتدئ – متقدم",
      image: programImages.quran,
    },
    {
      title: "أتقن اللغة العربية - المستوى الأول",
      description:
        "ابدأ رحلتك من الصفر بمنهج يركز على القراءة والكتابة والفهم. برنامج شامل يناسب جميع الأعمار والجنسيات.",
      icon: <Award size={40} />,
      outcomes: [
        "إتقان التأسيس: نطق الحروف العربية من مخارجها الصحيحة.",
        "مهارات الكتابة: تعلم الكتابة والقراءة بشكل سليم ومحترف.",
        "بناء الجمل: فهم القواعد الأساسية للغة العربية.",
        "تطوير الحصيلة: اكتساب مفردات جديدة ومتنوعة.",
        "القراءة بطلاقة: قراءة وفهم نصوص عربية بسيطة.",
        "التواصل الفعال: التحدث باللغة العربية الأساسية بثقة.",
      ],
      level: "المستوى: الأول - للمبتدئين",
      image: programImages.arabic,
    },
    {
      title: "برنامج إتقان وتجويد التلاوة",
      description:
        "ارتقِ بتلاوتك للقرآن الكريم وصحح أخطاءك الشائعة مع معلمين متخصصين. انطلقت رحلتك الآن لتصل إلى تلاوة خاشعة، صحيحة، ومتقنة.",
      icon: <Mic size={40} />,
      outcomes: [
        "دقة المخارج: ضبط مخارج الحروف العربية ونطقها بوضوح تام.",
        "إتقان التجويد: تطبيق أحكام التجويد الأساسية عملياً أثناء القراءة.",
        "تجاوز العقبات: معالجة الأخطاء الشائعة واللحن في التلاوة فوراً.",
        "جودة النطق: تحسين الأداء الصوتي ومخارج الكلمات القرآنية.",
        "التلاوة النموذجية: الوصول إلى مستوى متقدم من الإتقان والضبط.",
        "التوثيق: الحصول على شهادة معتمدة تثبت تطور مستواك.",
      ],
      level: "متوسط - متقدم",
